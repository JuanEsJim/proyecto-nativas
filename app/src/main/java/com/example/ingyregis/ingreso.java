...
public class ingreso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonLogin.setOnClickListener(v -> {
            ...
            if (username.isEmpty() || password.isEmpty()) {
                Toast.makeText(ingreso.this, "Por favor ingrese sus datos", Toast.LENGTH_SHORT).show();
            } else {
                // Consultar los usuarios registrados en SharedPreferences
                ...
                if (storedPassword != null && storedPassword.equals(password)) {
                    // Si las credenciales son correctas, redirigir a MainActivity
                    Intent intent = new Intent(ingreso.this, camara.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(ingreso.this, "Credenciales incorrectas", Toast.LENGTH_SHORT).show();
                }
            }
        });

        // Acción para ir a la actividad de registro (taller)
        textViewRegister.setOnClickListener(v -> {
            Intent intent = new Intent(ingreso.this, taller.class);
            startActivity(intent);
        });
    }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intentosFailedLogin >= MAX_INTENTOS) {
                    Toast.makeText(ingreso.this, "Has alcanzado el límite de intentos. Por favor, espera antes de intentar de nuevo.", Toast.LENGTH_LONG).show();
                    return;
                }
                iniciarProcesoLogin();
            }
    ...
    private void iniciarProcesoLogin() {
        ...
        oneTapClient.beginSignIn(signInRequest)
                .addOnSuccessListener(ingreso.this, new OnSuccessListener<BeginSignInResult>() {
                    @Override
                ...
                .addOnFailureListener(ingreso.this, new OnFailureListener() {
                    @Override
    ...
    private void manejarErrorLogin(Exception e) {
        ...
        if (e instanceof ApiException) {
            ...
            if (apiException.getStatusCode() == CommonStatusCodes.CANCELED) {
                ...
                Toast.makeText(ingreso.this, "Error al iniciar sesión: " + getErrorMessage(apiException.getStatusCode()), Toast.LENGTH_SHORT).show();
            }
        } else {
            Log.e(TAG, "Error no específico: " + e.getMessage(), e);
            Toast.makeText(ingreso.this, "Error inesperado: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }

        if (intentosFailedLogin >= MAX_INTENTOS) {
            Log.w(TAG, "Máximo de intentos alcanzado");
            Toast.makeText(ingreso.this, "Has alcanzado el límite de intentos fallidos. Inténtalo de nuevo más tarde.", Toast.LENGTH_LONG).show();
            button.setEnabled(false);
